//Mon Mar 03 2025 06:05:10 GMT+0000 (Coordinated Universal Time)
              ...
              if (_0x3c705e.welfare) {
                {
                  ...
                  let _0x329ed8 = await _0x3c705e.getCoin();
              ...
              if (_0x3c705e.carbon) {
                {
                  ...
                  let _0x5b989d = (await _0x3c705e.getReceiveEngeryList()) ?? [];
    ...
    try {
      {
        ...
        let _0x4ad8f7 = _0x572f41;
        let _0x15aac1 = await this.fetch(_0x4ad8f7);
        let {
          sign_daily: _0x1dfddd,
          sign_daily_reward: _0x5ac1b1
        } = _0x15aac1?.["data"]?.["cap_sign"] ?? {};
        let _0x48c68d = _0x1dfddd ? "今日获得" + _0x5ac1b1 / 1048576 + "MB" : _0x15aac1?.["message"] || "今日未签到";
    ...
    try {
      {
        ...
        let _0x52f8bf = _0x1ad671;
        let _0x25dc4b = await this.fetch(_0x52f8bf);
        let _0x4a90f2 = _0x25dc4b?.["data"]?.["sign_daily_reward"] ? "签到成功!" : "" + _0x25dc4b?.["message"];
    ...
    try {
      {
        ...
        let _0x20a8e4 = await this.fetch(_0x46daa0);
        let _0x1b1f17 = _0x20a8e4?.["msg"] || "获得" + _0x20a8e4?.["data"]?.["prizes"]?.[0]?.["rewardItem"]?.["name"];
    ...
    try {
      {
        ...
        let _0x2e4581 = await this.fetch(_0x44a32a);
    ...
    try {
      {
        ...
        let _0x585fdb = await this.fetch(_0x2dc3ef);
    ...
    try {
      {
        ...
        let _0x1b74c5 = _0x55ca99;
        let _0x1927de = await this.fetch(_0x1b74c5);
    ...
    try {
      {
        ...
        let _0x7dd2f4 = await this.fetch(_0x53c6e0);
        let _0x2754eb = _0x7dd2f4?.["msg"] || _0x7dd2f4?.["data"]?.["prizes"]?.[0]?.["rewardItem"]?.["name"];
    ...
    try {
      {
        ...
        let _0x30b0bf = _0x4cdaa7;
        let _0x1d0aa7 = await this.fetch(_0x30b0bf);
    ...
    try {
      {
        ...
        let _0x312230 = _0x1b3c44;
        let _0x2395ea = await this.fetch(_0x312230);
        let _0x3f51f1 = _0x2395ea?.["data"]?.["categoryList"];
        let _0x3edbab = [];
        if (_0x3f51f1?.["length"]) {
          {
    ...
    try {
      {
        ...
        let _0x559d63 = await this.fetch(_0xdad94a);
    ...
    try {
      {
        ...
        let _0x149a71 = _0x32998d;
        let _0x155e1b = await this.fetch(_0x149a71);
    ...
    try {
      {
        ...
        let _0x4a0aa7 = _0x456584;
        let _0x2c573b = await this.fetch(_0x4a0aa7);
  ...
  try {
    ...
    async function _0x4fbed5() {
      try {
        ...
        let _0x42d583 = await getUserInfo(_0x5a79f3);
        ...
        userCookie[_0x1bcfba] ? userCookie[_0x1bcfba] = {
          ...
          userId: _0x130f0f.userId,
          userName: _0x130f0f.userName,
          token: _0x130f0f.token
        } : userCookie.push(_0x130f0f);
        $.setdata(_0x42d583, "quark_user");
        $.msg($.name, "🎉" + _0x130f0f.userName + "更新token成功!", "当前获取ck信息对象:" + ($.quark_user || "未选择") + " => " + _0x130f0f.userName);
      } catch (_0x5bbd21) {
        throw _0x5bbd21;
      }
    }
    ...
    function _0x3b84bb() {
      try {
        ...
        let _0x461b95 = _0x5efa9a?.["data"]?.["curTask"]?.["name"];
...
async function getUserInfo(_0x396a2e) {
  try {
    ...
    let _0x56c799 = _0x86e76b;
    let _0x3334a4 = await Request(_0x56c799);
...
function UrlToJson(_0x2e0263) {
  ...
  for (let _0x559793 of _0x30974d) {
    ...
    let _0x256111 = _0x101885[0];
    let _0x351837 = decodeURIComponent(_0x101885[1]);
...
async function Request(t) {
  ...
  try {
    ...
    const i = t.timeout ? $.isSurge() ? t.timeout / 1000 : t.timeout : 10000;
    ...
    const m = $.http[p.toLowerCase()](l).then(t => "data" == u ? $.toObj(t.body) || t.body : $.toObj(t) || t).catch(t => $.log(`[${p.toUpperCase()}][ERROR]${t}\n`));
